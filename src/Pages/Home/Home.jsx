    ...
    return (
        <div className='h-full w-full flex  flex-col md:flex-row'>
            ...
            <div className="w-full h-full home-bg-green">
                <div className='w-full h-full pl-40 home-bg-blue flex flex-col justify-center items-start'>

                    <h1 className="text-white text-left">Hello, I am</h1>
                    <h1 className="md:text-5xl lg:text-6xl xl:text-6xl text-white font-bold">Abhijit Sarker</h1>
